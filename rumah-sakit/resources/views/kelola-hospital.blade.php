        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="kelola-hospital"><img class="rounded img-fluid" id="image" style="width:70px;height:70px;align-self: center" src="assets/img/logo.png"></a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="nav navbar-nav mr-auto">
                    <li class="nav-item mx-0 mx-lg-1 active" role="presentation"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/kelola-hospital">Kelola Rumah Sakit</a></li>
                ...
                <div class="card p-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" style="color: black" method="POST" action="">
                            ...
                            <div class="form-group">
                                <label style="color: black" for="exampleFormControlInput1">Nama Rumah sakit</label>
                                <input type="text" class="form-control" id="nama_hospital" name="nama_hospital" placeholder="Masukan Nama Rumah Sakit">
                            </div>
                            ...
                            <div class="form-group">
                                <label style="color: black" for="exampleFormControlInput1">Email</label>
